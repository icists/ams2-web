...
Vue.use(VueAuth, {
  ...
  loginData: { url: '/accounts/token-auth/', method: 'POST', redirect: '/dashboard', fetchUser: true },
  fetchData: { url: '/accounts/user/', enabled: false },
  registerData: { url: '/accounts/registration/', method: 'POST', redirect: '/dashboard', autoLogin: true, rememberMe: false },
  auth: jwtAuth,
